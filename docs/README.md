...
1. [Coding agent architecture](coding-agent-architecture.md) explains the
   identity, memory, and capability boundary with Beat Agent.
2. [Application architecture](architecture.md) explains workspace boundaries
   and the browser-to-storage request flow.
3. [S3-primary agent persistence](s3-primary-architecture.md) explains object
