...
- This is a pnpm + Turborepo personal coding-agent monorepo with SST, web, API, S3 persistence, and shared package layers.
...
- `packages/coding-agent`: coding assistant profile and capability policy.
...
| `pnpm dev:sst`                    | Start web and API SST development tasks.                 |
